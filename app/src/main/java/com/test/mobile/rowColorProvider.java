...
//
//public class rowColorProvider implements TableDataRowBackgroundProvider {
//    public rowColorProvider() {
//    }
//    @Override
...
//    }
//
////    private static class SelectedTableDataRowDrawableProvider implements TableDataRowBackgroundProvider<Object>{
////        private final Drawable colorDrawable;
////
////        public SelectedTableDataRowDrawableProvider(final int color) {
////            this.colorDrawable = new ColorDrawable(color);
////        }
////
////        @Override
