...
public class InstallmentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        table.addDataLongClickListener(new InstallmentActivity.tbleDataLongClickListener());
...
//                                .show();
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<String>(InstallmentActivity.this, android.R.layout.simple_spinner_item, projNo);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        pNoSP.setAdapter(adapter);
                    }
                    else {
                        AlertDialog.Builder builder = new AlertDialog.Builder(InstallmentActivity.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(InstallmentActivity.this);
...
//                                        .show();
    ...
    private class tbleDataLongClickListener implements TableDataLongClickListener<Item> {
        ...
        public boolean onDataLongClicked(int rowIndex, Item obj) {
            ...
            if(itemStatus.equals("Transferred")){
                ...
                updateTableStatusRequest updateTableStatusRequest = new updateTableStatusRequest(obj.getID(), "Install", responseListener);
                RequestQueue queue = Volley.newRequestQueue(InstallmentActivity.this);
                queue.add(updateTableStatusRequest);
                Toast.makeText(table.getContext(), "Install", Toast.LENGTH_SHORT).show();
            }
            ...
            else if(itemStatus.equals("Pending")){
                AlertDialog.Builder builder = new AlertDialog.Builder(InstallmentActivity.this);
